...
CREATE TABLE `project` (
  `id` int(10) UNSIGNED NOT NULL,
  `project_code` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
...
(12, '2017_03_18_003431_create_company_table', 1),
(13, '2017_03_18_004142_create_role_table', 1),
(14, '2017_03_18_004326_create_project_table', 1),
...
ALTER TABLE `state`
  ADD PRIMARY KEY (`id`),
  ADD KEY `state_project_id_foreign` (`project_id`);
